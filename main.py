...
async def dashboard():
    ...
    return "<h1 style='font-family:sans-serif'>OrbitalWatch online</h1>"
...
async def get_fire_data():
    try:
        ...
        return {"fires": fires, "total": len(fires), "source": "NASA FIRMS VIIRS", "region": "Brasil", "updated_at": datetime.utcnow().isoformat()}
    except Exception:
        return {
            "fires": [
            ...
            "total": 5, "source": "Dados simulados (demo)", "region": "Brasil", "updated_at": datetime.utcnow().isoformat()
        }
